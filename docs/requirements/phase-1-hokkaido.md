...
| Rusutsu two-route loop from Sapporo (day-08) | ~180 km | 7–9 hr door-to-door |
| Otaru → Sapporo car drop (day-18) | ~40 km | ~45 min |

Winter tires + snow chains mandatory; check 北海道開発局 道路情報 every morning of a drive leg.
...
**Transit in (day-03):** 特急 北斗 Hakodate → Sapporo (~3 hr 30 min).
**Transit out (day-10):** drive Sapporo → Wakkanai (loop begins, see Wakkanai section).
...
## Sapporo → Wakkanai drive (day-10 Mon 2027-01-04)

~330 km on 道央道 + R40. Summer ~4 hr; **winter 5–6 hr** with snow/ice + coastal gusts. Longest single drive of the trip — start early. Lunch at 岩見沢 or 旭川. Optional intermediate detour to Rumoi/Mashike along the Sea of Japan coast (Route 231) — not planned as overnight given Wakkanai already has the weather buffer.
...
## Wakkanai → Cape Sōya → Abashiri (day-12 Wed 2027-01-06, Okhotsk coast)

R238 along the Sea of Okhotsk, Hamatonbetsu → Monbetsu → Saroma → Abashiri. **~320 km / 5–6 hr winter** (add Cape Sōya detour from morning → effectively a full driving day). **This is the "ocean on the driver's side" leg — the whole point of the clockwise flip.** Leave at dawn, arrive Abashiri after dark.

⚠️ **Blizzard fallback:** re-route inland via R40 → 旭川 → R39 (+ ~1 hr, sacrifices the ocean view — defeats the clockwise rationale). Check the morning road report.
...
## Otaru → Sapporo car-drop → Windsor Toya (day-18 Tue 2027-01-12)
...
## Toya → Tokyo direct (day-21 Fri 2027-01-15, Phase 1 → Phase 2 boundary)

- Windsor early shuttle → JR 洞爺駅.
- **特急 北斗 洞爺 → 新函館北斗** (southbound, ~2 hr).
- **北海道新幹線 はやぶさ 新函館北斗 → 東京** (~4 hr). Reserve 特大荷物 on both legs.
- Total ~6–6.5 hr in motion + transfer.
- **Bad-weather fallback:** 特急 北斗 → 札幌 → 快速エアポート → 新千歳 → 羽田 (~1.5 hr flight).
