...
- **Stay candidates** (shortlisted 2026-04-20, not booked; 4 guests, 2 gents + 2 ladies ⇒ **2 rooms / 2 bedrooms minimum**). Airbnb candidates were previously priced for 2026-12-30 → 2027-01-01 (2 nights) — **dates need re-pricing** for the new Dec-27 arrival once night-count is fixed. ✅ **Chosen 2026-04-21: option 3 (TOKYU STAY 函館朝市 灯の湯)**; options 1 and 2 kept here for record but removed from the website.
  1. ~~**Airbnb — Hakodate Motomachi HIST Terrace I**~~ (ruled out 2026-04-21) — [Airbnb listing 1461937569120840875](https://www.airbnb.com.au/rooms/1461937569120840875). 6 guests · 3 BR · 6 beds · 2 baths · **4.92 ★ / 12 reviews · Guest favourite**. **A$854.45 total** (~A$427/night). "Rare find — usually booked." Motomachi historic-hillside area. Photos `public/photos/airbnb-hakodate-hist-terrace/01-04.jpg` (from listing, pulled 2026-04-21; listing only publishes 4 unique images).
  2. ~~**Airbnb — Hakodate Bay Japandi (136 ㎡, entire building)**~~ (ruled out 2026-04-21) — [Airbnb listing 896063721679005442](https://www.airbnb.com.au/rooms/896063721679005442). 10 guests · 2 BR · 5 beds · 2 baths · **New listing (0 reviews, new host)**. **A$767.10 total** (discounted from A$922.10; ~A$384/night). 3-min walk to Hakodate Bay (red-brick warehouses). Free residential garage + in-unit dryer. Photos `public/photos/airbnb-hakodate-bay-japandi/01-12.jpg` (from listing, pulled 2026-04-21).
  3. ✅ **Hotel — TOKYU STAY Hakodate-Asaichi Akari no Yu (東急ステイ函館朝市 灯の湯)** — chosen 2026-04-21 — [Google Maps](https://maps.app.goo.gl/NB15MnFHp38YbuYz8) · [Booking.com](https://www.booking.com/hotel/jp/tokyu-stay-hakodate-asaichi-akarinoyu.html) · [official site](https://www.tokyustay.co.jp/en/hotel/hakodate-asaichi-hokkaido/). 3-star hotel · 4.4 ★ / 1,277 reviews · in-house 灯の湯 onsen bath · right by 函館朝市 morning market and JR 函館駅 (walking distance). Rates to be priced for 2026-12-27 → 2026-12-30 (3 nights); requires **2 rooms** for our 2-gents-+-2-ladies setup. Photos `public/photos/hotel-tokyu-stay-hakodate-asaichi/01-12.jpg` (from official site, pulled 2026-04-21).
...
- **Additional "amazing view" suggestions (user asked for these):**
  ...
  - **流氷物語号 (Ryuhyo Monogatari Train) — OPTIONAL** — [JR Hokkaido info](https://www.jrhokkaido.co.jp/global/english/travel/tour-train/tour-train02.html). JR sightseeing train between **網走駅 ↔ 知床斜里駅** (Abashiri ↔ Shiretoko-Shari). Runs **January and February** each year — drift ice along the Sea of Okhotsk from the window, Shiretoko range in the distance, chance of white-tailed eagles / seals on the ice. ⚠️ **Timing overlap with our window is thin:** Phase-2 Abashiri nights fall around **early January 2027** (≈ day-11/12, i.e. 2027-01-06/07). The train's season typically starts **mid-to-late January**, so early-January dates may be before the train begins running. **Confirm 2027 season start date on JR Hokkaido's site before booking** — if the season opens in time, this pairs naturally with 知床 (Utoro) day and substitutes for actual-drift-ice experience otherwise limited to the Okhotsk Ryūhyō Museum.
...
- **Stay:** central Sapporo (Sapporo Station / Odori / Susukino corridor), **3 nights, 2 rooms**. Hotel not yet shortlisted. ⚠️ Consider whether to reuse the same hotel as the front-leg or pick a different area (Susukino vs Sapporo Station) to change scenery.
